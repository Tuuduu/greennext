...
export default function AtaTicket() {
    ...
    const ticketType = [
        "Авто техник", "Үйл ажиллагаа", "Барилга тохижилт", "Харуул хамгаалалт", "Бусад"
    ];
    ...
    return (
        <div className='w-[500px] shadow-lg p-10 rounded-lg border-t-4 border-green-400'>
            <form className="space-y-4 md:space-y-3" onSubmit={handleSubmit}>
                <label className='font-bold text-lg text-center'>ҮЙЛ АЖИЛГААНЫ ГАЗРЫН АЖЛЫН ДУУДЛАГА</label>
