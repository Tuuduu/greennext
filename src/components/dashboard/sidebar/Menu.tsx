    ...
    <div className="w-full flex flex-col items-center mt-8 gap-4">
      {menuItems.map((item, index) => (
        <button
          ...
          className="flex items-center gap-3 text-gray-800 bg-gray-100 dark:text-gray-300 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 font-medium rounded-lg text-sm px-5 py-2.5 text-left w-4/5 shadow-sm border border-gray-200 dark:border-gray-600 transition-all duration-200 transform hover:-translate-y-1"
        >
