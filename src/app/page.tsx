...
import BackgroundImage from "@/pic/LoginPage/Greengroup.jpg"
import { useState } from "react";
import LoginField from "@/app/components/LoginPage/Login"
...
export default function Login() {
  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center">
      ...
      <div className="z-10 w-1/3 h-1/2 bg-white flex flex-col gap-y-10 justify-center items-center rounded-lg shadow-2xl bg-opacity-100">
        {toggle === true ?
        ...
        <div>
          <button type="button" onClick={() => getToggle(!toggle)} className={buttonStyle1}>Админаар нэвтрэх</button>
        </div>
      </div>
    </div>
  );
